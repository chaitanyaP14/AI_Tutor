...
def create_presentation(output_path="AI_Tutor_Capstone_Presentation.pptx"):
    ...
    COLOR_ACCENT = RGBColor(14, 165, 233)  # #0EA5E9
    ...
    def add_header(slide, title_text, category_text="CAPSTONE PROJECT"):
    ...
    def create_card(slide, left, top, width, height, title="", border_accent=True):
    ...
    # Large Center Card
    create_card(slide1, Inches(1.5), Inches(1.2), Inches(10.333), Inches(5.1), border_accent=True)
    ...
    create_card(slide2, Inches(0.8), Inches(1.7), Inches(5.6), Inches(4.9), "Problem Statement")
    ...
    # Card 2: Impact & Need
    create_card(slide2, Inches(6.933), Inches(1.7), Inches(5.6), Inches(4.9), "Problem Impact & Industry Need")
    ...
    # Col 1: Retrieval Augmented Generation
    create_card(slide3, Inches(0.8), Inches(1.7), col_w, Inches(4.9), "Retrieval Augmented Generation")
    ...
    # Col 2: Verifiable Source Citations
    create_card(slide3, Inches(0.8) + col_w + gap, Inches(1.7), col_w, Inches(4.9), "Verifiable Source Citations")
    ...
    # Col 3: Comprehensive Prep Modules
    create_card(slide3, Inches(0.8) + (col_w + gap) * 2, Inches(1.7), col_w, Inches(4.9), "Comprehensive Prep Modules")
    ...
    # Left Card: Offline Ingestion Pipeline
    create_card(slide4, Inches(0.8), Inches(1.7), Inches(5.6), Inches(4.9), "Offline Ingestion Pipeline")
    ...
    for p_title, p_desc in pipe1:
        p = tf.add_paragraph()
        p.text = f"1. {p_title}: {p_desc}"
        p.font.size = Pt(10)
        p.font.color.rgb = COLOR_TEXT_MAIN
        p.space_after = Pt(8)

    # Right Card: Real-Time Query Pipeline
    create_card(slide4, Inches(6.933), Inches(1.7), Inches(5.6), Inches(4.9), "Real-Time Query Pipeline")
    ...
    # Feature 1
    create_card(slide5, Inches(0.8), Inches(1.7), card_w2, card_h2, "Multi-Syllabus Scope Selector")
    ...
    # Feature 2
    create_card(slide5, Inches(6.933), Inches(1.7), card_w2, card_h2, "Instant Doubt Resolution with Citations")
    ...
    # Feature 3
    create_card(slide5, Inches(0.8), Inches(4.3), card_w2, card_h2, "Day-by-Day Study Roadmap Generator")
    ...
    # Feature 4
    create_card(slide5, Inches(6.933), Inches(4.3), card_w2, card_h2, "Practice Quiz & Concept Clarifier")
    ...
    # Left Container: Embedded Screenshot
    ...
    # Right Container: Results Highlights
    create_card(slide6, Inches(8.8), Inches(1.6), Inches(3.733), Inches(4.9), "Results Highlights")
    tb = slide6.shapes.add_textbox(Inches(9.0), Inches(2.3), Inches(3.333), Inches(4.0))
    tf = tb.text_frame
    tf.word_wrap = True
    res_items = [
        ("Visual Excellence", "Executive dark slate design system with crisp typography and responsive metric cards."),
    ...
    # 3 Column Cards
    create_card(slide7, Inches(0.8), Inches(1.7), col_w, Inches(4.9), "Input Data Quality Dependency")
    ...
    create_card(slide7, Inches(0.8) + col_w + gap, Inches(1.7), col_w, Inches(4.9), "Text-Based Extraction Constraints")
    ...
    create_card(slide7, Inches(0.8) + (col_w + gap) * 2, Inches(1.7), col_w, Inches(4.9), "Ambiguity & API Boundaries")
    ...
    # 4 Cards Grid (2x2)
    create_card(slide8, Inches(0.8), Inches(1.7), card_w2, card_h2, "Multimodal RAG Engine (Vision & Diagrams)")
    ...
    create_card(slide8, Inches(6.933), Inches(1.7), card_w2, card_h2, "Student Progress & Analytics Dashboard")
    ...
    create_card(slide8, Inches(0.8), Inches(4.3), card_w2, card_h2, "Institutional LMS Integration")
    ...
    create_card(slide8, Inches(6.933), Inches(4.3), card_w2, card_h2, "Adaptive Learning & Multi-Language Support")
    ...
    create_card(slide9, Inches(0.8), Inches(1.7), Inches(11.733), Inches(4.9), "Full Technology Stack Matrix")

    # Create Table inside slide
    rows, cols = 5, 4
    ...
    data = [
        ("Frontend UI", "Streamlit 1.61+", "User Interface & Tab Navigation", "Executive dark slate design system, Google Fonts (Plus Jakarta Sans & Inter)"),
    ...
    for row_idx, row_data in enumerate(data, 1):
        for col_idx, cell_value in enumerate(row_data):
            ...
            cell.fill.solid()
            cell.fill.fore_color.rgb = RGBColor(15, 23, 42) if row_idx % 2 == 1 else RGBColor(11, 15, 23)
            p = cell.text_frame.paragraphs[0]
            p.text = cell_value
            p.font.size = Pt(10)
            p.font.color.rgb = COLOR_TEXT_MAIN
    ...
    print(f"Successfully generated presentation PPTX: {output_path}")
